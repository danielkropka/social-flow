        ...
        <div className="mx-auto max-w-7xl px-4 xl:px-12">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Dostosuj funkcjonalności do swoich potrzeb i rozwijaj się wraz z
              nami
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            {Object.values(STRIPE_PLANS).map((plan) => (
              <div
                key={plan.id}
                className="bg-white/80 backdrop-blur-xl p-8 rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col group relative overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-full -mr-16 -mt-16 opacity-60 group-hover:opacity-80 transition-opacity duration-300" />
                ...
                <Button
                  className="mt-auto w-full bg-gradient-to-r from-blue-600 via-blue-500 to-blue-700 text-white border-0 shadow-md hover:shadow-lg transition-all duration-300 h-12 flex items-center justify-center rounded-xl font-semibold relative z-10 hover:scale-[1.02] focus-visible:ring-4 focus-visible:ring-blue-300"
                  onClick={() =>
                    handleSubscribe(
